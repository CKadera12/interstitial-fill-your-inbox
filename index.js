...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[636,870,206,169],[958,77,50,48],[958,127,41,46],[0,482,210,172],[534,348,210,172],[746,348,210,172],[322,0,210,172],[534,174,210,172],[322,348,210,172],[636,696,210,172],[424,696,210,172],[212,522,210,172],[848,789,144,97],[746,0,210,172],[0,656,210,172],[424,522,210,172],[636,522,210,172],[0,830,210,172],[322,174,210,172],[212,696,210,172],[746,174,210,172],[212,870,210,172],[534,0,210,172],[424,870,210,172],[958,175,31,59],[844,888,84,74],[0,0,320,480],[958,0,32,75],[848,522,115,265]]}
];
...
(lib.final_mobileinterstitialsimpleinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(160,240,1.063,1.032);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},9).wait(176));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(30).to({y:170.2},0).to({alpha:1},10).wait(145));

	// logo
	this.instance_2 = new lib.kalelogointerstial();
	this.instance_2.parent = this;
	this.instance_2.setTransform(160,37);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({scaleX:0.06,scaleY:0.06},0).to({scaleX:1.09,scaleY:1.09,alpha:1},6,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},8,cjs.Ease.get(1)).wait(162));
	...
	// sign-up
	this.instance_3 = new lib.signupinterstitial();
	this.instance_3.parent = this;
	this.instance_3.setTransform(160,327.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(48).to({y:290.3},0).to({y:332.4,alpha:1},10,cjs.Ease.get(1)).to({y:327.4},8,cjs.Ease.get(1)).wait(119));
	...
	// cta-rectangle
	this.instance_4 = new lib.ctarectangleinterstitial();
	this.instance_4.parent = this;
	this.instance_4.setTransform(160,326.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(48).to({y:290.3},0).to({y:331.8,alpha:1},10,cjs.Ease.get(0.96)).to({y:326.8},8,cjs.Ease.get(1)).wait(119));

	// Party-Ready Recipes
	this.instance_5 = new lib.partyreadyinterstitial();
	this.instance_5.parent = this;
	this.instance_5.setTransform(160,254.7);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(40).to({alpha:1},10).wait(57).to({alpha:0},5).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(167).to({alpha:1},10).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(137).to({alpha:1},10).wait(20).to({alpha:0},5).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(107).to({y:235.6},0).to({alpha:1},10).wait(20).to({alpha:0},5).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(87).to({alpha:1},0).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(84).to({alpha:1},0).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(77).to({alpha:1},0).wait(108));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(70).to({alpha:1},0).wait(115));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(66).to({alpha:1},0).wait(119));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(62).to({alpha:1},0).wait(123));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(58).to({alpha:1},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(54).to({alpha:1},0).wait(131));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(50).to({alpha:1},0).wait(135));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(46).to({alpha:1},0).wait(139));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(42).to({alpha:1},0).wait(143));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(38).to({alpha:1},0).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(34).to({alpha:1},0).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(30).to({alpha:1},0).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(26).to({alpha:1},0).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(22).to({alpha:1},0).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(18).to({alpha:1},0).wait(167));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(14).to({alpha:1},0).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(9).to({alpha:1},10).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_37).wait(185));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1507132112194", id:"index_atlas_"}
	],
	preloads: []
};
