...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[746,174,210,172],[322,348,210,172],[534,348,210,172],[746,348,210,172],[0,482,210,172],[212,522,210,172],[424,522,210,172],[636,522,210,172],[0,656,210,172],[212,696,210,172],[424,870,210,172],[322,174,210,172],[534,174,210,172],[746,0,210,172],[322,0,210,172],[534,0,210,172],[424,696,210,172],[636,696,210,172],[0,830,210,172],[212,870,210,172],[0,0,320,480]]}
];
...
// stage content:
(lib.interstitialfillyourinbox = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(40).to({alpha:1},10).wait(57).to({alpha:0},5).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(167).to({alpha:1},10).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(137).to({alpha:1},10).wait(20).to({alpha:0},5).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(107).to({y:235.6},0).to({alpha:1},10).wait(20).to({alpha:0},5).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(87).to({alpha:1},0).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(84).to({alpha:1},0).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(77).to({alpha:1},0).wait(108));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(70).to({alpha:1},0).wait(115));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(66).to({alpha:1},0).wait(119));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(62).to({alpha:1},0).wait(123));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(58).to({alpha:1},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(54).to({alpha:1},0).wait(131));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(50).to({alpha:1},0).wait(135));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(46).to({alpha:1},0).wait(139));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(42).to({alpha:1},0).wait(143));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(38).to({alpha:1},0).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(34).to({alpha:1},0).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(30).to({alpha:1},0).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(26).to({alpha:1},0).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(22).to({alpha:1},0).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(18).to({alpha:1},0).wait(167));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(14).to({alpha:1},0).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(9).to({alpha:1},10).wait(166));

	// cookie-one
	this.instance_29 = new lib.cookiebluetray();
	this.instance_29.parent = this;
	this.instance_29.setTransform(219,398);

	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(185));

	// table
	this.instance_30 = new lib.Interstitialtable_1();
	this.instance_30.parent = this;
	this.instance_30.setTransform(160,240);

	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(185));
